  ...
  return (
      <div className="about-card">
        <button className="mail">
          <a href="mailto:jack.owl03m@gmail.com">
        ...
        <div className="bottom">
          <div className="content">
            ...
            <span className="about-me">21 y/o Software Engineer passionate about technology, coding, and innovation.
            </span>
          </div>
          <div className="bottom-bottom">
            <div className="social-links-container">
              <a href="https://instagram.com/_.red_owl._">
              ...
              <a href="https://github.com/Marxo03">
